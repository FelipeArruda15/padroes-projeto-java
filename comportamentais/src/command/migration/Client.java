package command.migration;

import java.util.LinkedHashMap;
import java.util.List;
import java.util.Map;

import command.migration.commands.ProductTable;
import command.migration.commands.UserTable;
import command.migration.commands.UserTableRoleColumn;
